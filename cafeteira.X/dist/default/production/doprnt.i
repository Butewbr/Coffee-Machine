...
# 1 "D:/Arquivos de Programas/mplab/packs/Microchip/PIC16Fxxx_DFP/1.2.33/xc8\\pic\\include\\__unsupported.h" 1 3
...
# 1138 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c"
    ...
    if(flag & 0x04) {
     ...
     if(flag & 0x03)
      ...
      ((*sp++ = ('-')));
# 1194 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c"
     while(width > 0) {
      ((*sp++ = ('0')));
      width--;
     }
